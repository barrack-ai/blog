...
**Current GPU cloud pricing for inference (early 2026):**

| GPU | On-Demand Range ($/GPU-hr) | HBM | Bandwidth |
|---|---|---|---|
| A100 | $1.29 to $2.29 | 80 GB | 2.0 TB/s |
| H100 | $1.49 to $5.00 | 80 GB | 3.35 TB/s |
| H200 | $2.50 to $10.60 | 141 GB | 4.8 TB/s |
| B200 | ~20-30% above H200 | 192 GB | 8.0 TB/s |
...
*Sources: Jarvislabs, GMI Cloud, Spheron, Genesis Cloud, MLPerf v5.0 and v5.1 results.*
